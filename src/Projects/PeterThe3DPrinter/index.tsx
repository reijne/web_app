...
const FILAMENTS: Filament[] = [
    ...
    { material: 'PLA', color: 'Beige', hexColor: '#f7e6df' },
    ...
    { material: 'PLA', color: 'Mistletoe', hexColor: '#3f8c43' },
    { material: 'PLA', color: 'Cyan', hexColor: '#0086d6' },
    { material: 'PLA', color: 'Blue', hexColor: '#0a2989' },
    { material: 'PLA', color: 'Purple', hexColor: '#5e43b7' },
    { material: 'PLA Silk', color: 'Silver', hexColor: '#c8c8c8' },
    { material: 'PLA Silk', color: 'Gold', hexColor: '#f5a925' },
